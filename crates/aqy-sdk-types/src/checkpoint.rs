...
/// A header for a Checkpoint on the Aqy blockchain.
///
/// On the Aqy network, checkpoints define the history of the blockchain. They are quite similar to
/// the concept of blocks used by other blockchains like Bitcoin or Ethereum. The Aqy blockchain,
