...
/// ```
///
/// Due to historical reasons, even though a `Digest` has a fixed-length of 32, Aqy's binary
...
// Unfortunately aqy's binary representation of digests is prefixed with its length meaning its
