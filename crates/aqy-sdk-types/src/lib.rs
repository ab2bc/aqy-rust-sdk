//! Core type definitions for the [Aqy] blockchain.
//!
//! [Aqy] is a next-generation smart contract platform with high throughput, low latency, and an
//! asset-oriented programming model powered by the Move programming language. This crate provides
//! type definitions for working with the data that makes up the [Aqy] blockchain.
//!
//! [Aqy]: https://aqy.io
//!
//! # Feature flags
...
//! extensively throughout the Aqy ecosystem. In particular the BCS format is leveraged because it
...
//! that the network produces. The one caveat to this would be that as the Aqy protocol evolves,
...
//! new variants and types as they are released to Aqy's `testnet` network.
//!
