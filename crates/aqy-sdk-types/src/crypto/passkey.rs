...
/// the required json-schema for the `client-data-json` rule. In addition, Aqy currently requires
...
mod serialization {
    ...
    pub(super) enum ClientDataType {
        ...
        ///
        /// Passkey's in Aqy only support the value `"webauthn.get"`, other values will be rejected.
