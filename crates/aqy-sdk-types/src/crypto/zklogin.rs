...
/// ## Note
///
/// Due to a historical bug that was introduced in the Aqy Typescript SDK when the zklogin
...
/// these addresses, the Aqy network decided to change the protocol to allow for a zklogin
