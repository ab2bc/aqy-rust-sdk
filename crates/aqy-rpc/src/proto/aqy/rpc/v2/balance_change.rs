...
impl From<aqy_sdk_types::BalanceChange> for BalanceChange {
    fn from(value: aqy_sdk_types::BalanceChange) -> Self {
        Self {
...
impl Merge<&aqy_sdk_types::BalanceChange> for BalanceChange {
    fn merge(&mut self, source: &aqy_sdk_types::BalanceChange, mask: &crate::field::FieldMaskTree) {
...
impl TryFrom<&BalanceChange> for aqy_sdk_types::BalanceChange {
