mod _accessor_impls {
    ...
    impl super::EndOfEpochTransactionKind {
        ...
        ///If any other oneof field in the same oneof is set, it will be cleared.
        pub fn set_bridge_object_version<T: Into<u64>>(&mut self, field: T) {
            self.data = Some(
                super::end_of_epoch_transaction_kind::Data::BridgeObjectVersion(
                    field.into().into(),
                ),
        ...
        ///Sets `bridge_object_version` with the provided value.
        ///If any other oneof field in the same oneof is set, it will be cleared.
        pub fn with_bridge_object_version<T: Into<u64>>(mut self, field: T) -> Self {
            self.set_bridge_object_version(field.into());
            self
        }
    }
    impl super::Epoch {
    ...
    impl super::StakingPool {
        pub const fn const_default() -> Self {
            Self {
                ...
                exchange_rates: None,
                pending_stake: None,
                pending_total_aqy_withdraw: None,
        ...
        ///If `aqy_balance` is set, returns [`Some`] with a mutable reference to the value; otherwise returns [`None`].
        pub fn aqy_balance_opt_mut(&mut self) -> Option<&mut u64> {
            self.aqy_balance.as_mut().map(|field| field as _)
        }
        ///Returns a mutable reference to `aqy_balance`.
        ///If the field is unset, it is first initialized with the default value.
        pub fn aqy_balance_mut(&mut self) -> &mut u64 {
            self.aqy_balance.get_or_insert_default()
        }
        ///If `aqy_balance` is set, returns [`Some`] with the value; otherwise returns [`None`].
        pub fn aqy_balance_opt(&self) -> Option<u64> {
            self.aqy_balance.as_ref().map(|field| *field)
        }
        ///Sets `aqy_balance` with the provided value.
        pub fn set_aqy_balance<T: Into<u64>>(&mut self, field: T) {
            self.aqy_balance = Some(field.into().into());
        }
        ///Sets `aqy_balance` with the provided value.
        pub fn with_aqy_balance<T: Into<u64>>(mut self, field: T) -> Self {
            self.set_aqy_balance(field.into());
            self
        }
        ...
        ///If `pending_total_aqy_withdraw` is set, returns [`Some`] with a mutable reference to the value; otherwise returns [`None`].
        pub fn pending_total_aqy_withdraw_opt_mut(&mut self) -> Option<&mut u64> {
            self.pending_total_aqy_withdraw.as_mut().map(|field| field as _)
        }
        ///Returns a mutable reference to `pending_total_aqy_withdraw`.
        ///If the field is unset, it is first initialized with the default value.
        pub fn pending_total_aqy_withdraw_mut(&mut self) -> &mut u64 {
            self.pending_total_aqy_withdraw.get_or_insert_default()
        }
        ///If `pending_total_aqy_withdraw` is set, returns [`Some`] with the value; otherwise returns [`None`].
        pub fn pending_total_aqy_withdraw_opt(&self) -> Option<u64> {
            self.pending_total_aqy_withdraw.as_ref().map(|field| *field)
        }
        ///Sets `pending_total_aqy_withdraw` with the provided value.
        pub fn set_pending_total_aqy_withdraw<T: Into<u64>>(&mut self, field: T) {
            self.pending_total_aqy_withdraw = Some(field.into().into());
        }
        ///Sets `pending_total_aqy_withdraw` with the provided value.
        pub fn with_pending_total_aqy_withdraw<T: Into<u64>>(
            mut self,
            field: T,
        ) -> Self {
            self.set_pending_total_aqy_withdraw(field.into());
            self
        }
