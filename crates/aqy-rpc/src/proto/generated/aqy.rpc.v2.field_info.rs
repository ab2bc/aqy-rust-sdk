mod _field_impls {
    ...
    impl StakingPool {
        ...
        pub const AQY_BALANCE_FIELD: &'static MessageField = &MessageField {
            name: "aqy_balance",
        ...
        pub const PENDING_TOTAL_AQY_WITHDRAW_FIELD: &'static MessageField = &MessageField {
            name: "pending_total_aqy_withdraw",
            json_name: "pendingTotalAqyWithdraw",
            number: 9i32,
            message_fields: None,
        };
    ...
    impl StakingPoolFieldPathBuilder {
        ...
        pub fn aqy_balance(mut self) -> String {
            self.path.push(StakingPool::AQY_BALANCE_FIELD.name);
            self.finish()
        }
        ...
        pub fn pending_total_aqy_withdraw(mut self) -> String {
            self.path.push(StakingPool::PENDING_TOTAL_AQY_WITHDRAW_FIELD.name);
            self.finish()
        }
