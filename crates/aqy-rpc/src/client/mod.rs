...
use crate::proto::aqy::rpc::v2beta2::ledger_service_client::LedgerServiceClient;
use crate::proto::aqy::rpc::v2beta2::live_data_service_client::LiveDataServiceClient;
use crate::proto::aqy::rpc::v2beta2::move_package_service_client::MovePackageServiceClient;
use crate::proto::aqy::rpc::v2beta2::signature_verification_service_client::SignatureVerificationServiceClient;
use crate::proto::aqy::rpc::v2beta2::subscription_service_client::SubscriptionServiceClient;
use crate::proto::aqy::rpc::v2beta2::transaction_execution_service_client::TransactionExecutionServiceClient;
use crate::proto::aqy::rpc::v2beta2::ExecuteTransactionRequest;
use crate::proto::aqy::rpc::v2beta2::ExecutedTransaction;
use crate::proto::aqy::rpc::v2beta2::SubscribeCheckpointsRequest;
...
impl Client {
    /// URL for the public-good, Aqy Foundation provided fullnodes for mainnet.
    pub const MAINNET_FULLNODE: &str = "https://fullnode.mainnet.aqy.io";

    /// URL for the public-good, Aqy Foundation provided fullnodes for testnet.
    pub const TESTNET_FULLNODE: &str = "https://fullnode.testnet.aqy.io";

    /// URL for the public-good, Aqy Foundation provided fullnodes for devnet.
    pub const DEVNET_FULLNODE: &str = "https://fullnode.devnet.aqy.io";

    /// URL for the public-good, Aqy Foundation provided archive for mainnet.
    pub const MAINNET_ARCHIVE: &str = "https://archive.mainnet.aqy.io";

    /// URL for the public-good, Aqy Foundation provided archive for testnet.
    pub const TESTNET_ARCHIVE: &str = "https://archive.testnet.aqy.io";
    ...
    pub async fn execute_transaction_and_wait_for_checkpoint(
        ...
        let executed_txn_digest = aqy_sdk_types::Transaction::try_from(transaction)
