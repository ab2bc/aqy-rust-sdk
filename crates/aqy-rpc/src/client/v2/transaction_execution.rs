...
use crate::proto::aqy::rpc::v2::ExecuteTransactionRequest;
use crate::proto::aqy::rpc::v2::ExecuteTransactionResponse;
use crate::proto::aqy::rpc::v2::SubscribeCheckpointsRequest;
...
impl Client {
    ...
    pub async fn execute_transaction_and_wait_for_checkpoint(
        ...
        let executed_txn_digest = match aqy_sdk_types::Transaction::try_from(transaction) {
