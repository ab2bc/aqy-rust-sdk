...
use crate::proto::aqy::rpc::v2::simulate_transaction_request::TransactionChecks;
use crate::proto::aqy::rpc::v2::Argument;
use crate::proto::aqy::rpc::v2::GetObjectRequest;
use crate::proto::aqy::rpc::v2::Input;
use crate::proto::aqy::rpc::v2::ListOwnedObjectsRequest;
use crate::proto::aqy::rpc::v2::MoveCall;
use crate::proto::aqy::rpc::v2::Object;
use crate::proto::aqy::rpc::v2::ProgrammableTransaction;
use crate::proto::aqy::rpc::v2::SimulateTransactionRequest;
use crate::proto::aqy::rpc::v2::Transaction;
...
impl Client {
    pub async fn get_delegated_stake(&mut self, staked_aqy_id: &Address) -> Result<DelegatedStake> {
        let maybe_staked_sui = self
            .ledger_client()
            .get_object(
                GetObjectRequest::new(staked_aqy_id)
    ...
    pub async fn list_delegated_stake(&mut self, address: &Address) -> Result<Vec<DelegatedStake>> {
        ...
        let mut list_request = ListOwnedObjectsRequest::default()
            ...
            .with_read_mask(FieldMask::from_str("contents"))
            .with_object_type(STAKED_AQY_TYPE);
    ...
    async fn calculate_rewards(
        ...
        if staked_aqy_ids.len() != resp.command_outputs.len() {
            return Err(tonic::Status::from_error(
        ...
        for (id, output) in staked_aqy_ids.iter().zip(resp.command_outputs) {
