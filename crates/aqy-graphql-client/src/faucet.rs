...
pub const FAUCET_DEVNET_HOST: &str = "https://faucet.devnet.aqy.io";
pub const FAUCET_TESTNET_HOST: &str = "https://faucet.testnet.aqy.io";
...
pub enum FaucetError {
    #[error("Missing X-Turnstile-Token header. For testnet tokens, please use the Web UI: https://faucet.aqy.io")]
