...
pub use aqyns::DefaultAqynsNameQuery;
pub use aqyns::DefaultAqynsNameQueryArgs;
pub use aqyns::ResolveAqynsQuery;
pub use aqyns::ResolveAqynsQueryArgs;
...
impl_scalar!(Address, schema::AqyAddress);
