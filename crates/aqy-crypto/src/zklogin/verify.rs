...
use aqy_sdk_types::Bn254FieldElement;
use aqy_sdk_types::CircomG1;
use aqy_sdk_types::CircomG2;
use aqy_sdk_types::Ed25519PublicKey;
use aqy_sdk_types::Jwk;
use aqy_sdk_types::Secp256k1PublicKey;
use aqy_sdk_types::Secp256r1PublicKey;
use aqy_sdk_types::SimpleSignature;
use aqy_sdk_types::ZkLoginInputs;
use aqy_sdk_types::ZkLoginProof;
...
/// Calculate the Aqy address based on address seed and address params.
#[allow(unused)]
fn gen_address_seed(
    salt: &str,
    name: &str,  // i.e. "sub"
